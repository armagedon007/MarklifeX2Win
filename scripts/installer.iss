...
begin
  ...
  ShellExec('', 'powershell.exe', '-Command "Remove-Printer -Name ''X2 Print Label'' -ErrorAction SilentlyContinue; Remove-PrinterPort -Name ''Marklife_127.0.0.1'' -ErrorAction SilentlyContinue"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
end;
...
var
  ...
  ResultCode: Integer;
begin
  PSCommand := 'Remove-Printer -Name ''X2 Print Label'' -ErrorAction SilentlyContinue; Remove-PrinterPort -Name ''Marklife_127.0.0.1'' -ErrorAction SilentlyContinue; $newPort = ([WMIClass] ''root\cimv2:Win32_TCPIPPrinterPort'').CreateInstance(); $newPort.Name = ''Marklife_127.0.0.1''; $newPort.HostAddress = ''127.0.0.1''; $newPort.PortNumber = 631; $newPort.Protocol = 1; $newPort.Put(); Add-Printer -Name ''X2 Print Label'' -PortName ''Marklife_127.0.0.1'' -DriverName ''Microsoft IPP Class Driver''; Restart-Service Spooler -Force -ErrorAction SilentlyContinue';
